...
import { ElementsType, FormElementInstance, FormElements } from './FomElements';
                            ...
                            <div className="flex flex-col w-full gap-2 p-4">
                                {
                                    elements.map((element) => (
                                        <DesigenerElementWrapper key={element.id} element={element} />
                                    ))
                                }
                            </div>
                        )
...
function DesigenerElementWrapper({ element }: { element: FormElementInstance }) {
